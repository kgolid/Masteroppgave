...
It is now much easier to formally express the new vel-definition, based on the generalized concept of trimming from Definition~\ref{def:new_trimming}, without using concepts of provability.
...
$a$ and $b$ are therefore not $V_3$-related, so implication (2) fails.
