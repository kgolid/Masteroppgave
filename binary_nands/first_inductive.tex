...
As a result of removing this constraint from the proof step, we obtained a more general vel-definition, $V_3$.

The question now is therefore ``What is left to generalize?''.
