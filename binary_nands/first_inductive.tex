...
\end{figure}
\FloatBarrier
The above proofs does not rely on any provably false vertex, but it rather makes us of the fact that $z$ is connected to one of the vertices contained in the NAND-clause that we are trying to prove.
...
All the graph structures presented in thic chapter so far can easily be defined inductively.
