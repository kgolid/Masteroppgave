...
\begin{proof}
  ...
  \end{align}
  The inductive part of the $V_2$ definition reveals two properties of the sets $D_b$, $D_a$ and $D_d$:
  \begin{itemize}
...
$a$ and $b$ has a total of 3 successors, whereas 2 are sinks and thereby unable to satisfy the requirement.
The last successor is the vertex $x$, which again only has one successor, vertex $y$.\par
\begin{figure}[!h]
  \centering
  \begin{tikzpicture}
    [
