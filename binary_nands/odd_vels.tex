...
The figure above shows two examples of odd paths that have had some of their edges flipped.
In both examples, the shown kernel contains both $a$ and $b$, showing that these constructions are not providing a provable NAND-clause $\ol{ab}$ in Neg.
