...
\end{lemma}
\begin{proof}
  We prove the lemma by structural induction over the complexity of the proof tree.
...
\begin{proof}
  ...
  \begin{figure}[!h]
    ...
    \begin{prooftree}
      ...
      \Hypo{\ol{a^Wp^W}}
      \Hypo{\ol{a^Ep^E}}
      \Infer[right label=$sa^Na^Wa^E$]4{\ol{p^Np^Wp^E}}
    \end{prooftree}
    \caption{}
