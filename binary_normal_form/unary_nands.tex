...
Except for the case where $\gamma = x^K_i$, the only $\gamma$-substitution that makes both of these NAND-clauses provable is $\gamma = t$\todo{show assignments}, giving us $\ol{at}$ in the conclusion.
...
The only $\gamma$-substitution applicable such that both $\ol{\gamma b^L}$ and $\ol{\gamma b^R}$ is provable is, again, $\gamma = t$\todo{show assignments}, giving us $\ol{at}$ in the conclusion.
