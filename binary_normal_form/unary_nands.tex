...
The fact that some binary NAND-clauses are not binary-derivable will now be used to show that some \textit{unary} NAND-clauses are not binary-derivable.
...
For the inductive step, suppose we have a proof that concludes with some binary NAND-clause $\ol{a\gamma}$;
