% !TEX root= ../main.tex
\section{Proving inconsistency in unrestricted theories}
...
This means not only that we are unable to keep the clause length at 2, but also that we cannot control these clause lengths at all!
