...
It is generally true that $\mathcal{G}$ gives us the correspondence we are looking for\cite{apal-digraph}.

With the problem of solutions being equal to the problem of models, we get our final equivalence between kernels and models.
