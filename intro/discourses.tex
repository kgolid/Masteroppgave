...
There is a simple translation from conjunctive normal from to graph normal form (shown in the end of this section), showing that any propositional theory can be written in GNF.
...
The properties in the graph also provides us with the satisfying models, if they exist.
