...
We set no restrictions on the cardinality of our clauses, meaning that both the OR-clauses and the NAND-clauses can be both finite and infinite in size.
Note that an infinite graph gives us infinitely many NAND-clauses, while an infinitary graph also gives us infinitely long OR-clauses.
