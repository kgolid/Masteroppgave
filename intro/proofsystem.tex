...
\subsubsection{Inconsistency of the Yablo-graph}
\label{subs:Inconsistency of the Yablo-graph}
...
\end{prooftree*}
Another example of an inconsistent graph is the Stretched Yablo-graph.
Its inconsistency proof in Neg is not as trivial as the one shown above, and can be found in the appendix together with the definition of Streched Yablo.
