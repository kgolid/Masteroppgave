...
It is shown in \cite{} that Neg is sound and refutational complete for theories with only a finite number of OR-clauses.
...
The remainder of this thesis will be focused mainly on exploring such patterns.
