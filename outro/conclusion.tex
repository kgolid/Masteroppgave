...
Based on this observation, one might be able to find some interesting relations between the kernels in the graph and the set $A$.\todo{examples?}

Also, more work could be put into exploring graph structural relations $V$ such that for a graph $G$ and a set $A \subseteq G$ we have $G \vdash \ol{A} \Rightarrow V(A)$.
